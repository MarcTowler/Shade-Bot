module.exports = class {
    ...
    async run () {
        ...
        //this.client.user.setActivity(`${this.client.config.defaultSettings.prefix}help`, {type: "PLAYING"});
        ...
        setInterval(() => {
            ...
            this.client.user.setActivity(activity_list[index]); // sets bot's activities to one of the phrases in the arraylist.
        }, 60000);
    }
};
